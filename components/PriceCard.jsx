  ...
  return (
    <article
      className={`relative flex flex-col rounded-2xl p-8 shadow-lg ${
        popular
          ? "bg-zinc-950 text-white ring-2 ring-white"
          : "bg-zinc-900 text-white ring-1 ring-white/10"
      }`}
    >
      {popular && (
        <span className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-white px-4 py-1 text-xs font-bold uppercase tracking-wide text-zinc-950">
          Terpopuler
        </span>
      )}
